...
namespace FacesDetect
{
    public partial class Training_Form : Form
    {
        ...
        public Training_Form(Main_Form1 _Parent)
        {
            InitializeComponent();
            Parent = _Parent;
            Face = Parent.Face;
        ...
        public Training_Form(VideoForm _Parent1)
        {
            InitializeComponent();
            Parent1 = _Parent1;
            Face = Parent1.Face;
           // Face = new CascadeClassifier(Application.StartupPath + "\\Cascades\\haarcascade_frontalface_alt2.xml");
            ENC_Parameters.Param[0] = ENC;
            Image_Encoder_JPG = GetEncoder(ImageFormat.Jpeg);
            initialise_capture();
        }
